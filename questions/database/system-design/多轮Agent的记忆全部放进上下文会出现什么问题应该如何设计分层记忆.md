---
id: q0116
question: "多轮Agent的记忆全部放进上下文会出现什么问题？应该如何设计分层记忆？"
category: system-design
tags: ["hierarchical", "memory", "context", "agent"]
difficulty: hard
created: 2026-07-24 09:33:49
source: 校招面试
---

# 多轮Agent的记忆全部放进上下文会出现什么问题？应该如何设计分层记忆？
...
> 📋 **分类**: 系统设计
> 🏷️ **标签**: `hierarchical` `memory` `context` `agent`
> 📊 **难度**: 进阶
> 📅 **归档时间**: 2026-07-24 09:33:49
